...
import edu.cuny.sys.SystemIniter;
...
public final class Game {
	...
	public static final String BANNER = ""
			...
			+ " - (C) 2006-2013 Jinzhong Niu, Kai Cai. \n\n" + Game.NAME
	...
	public static void setupObjectRegistry() {
		SystemIniter.setupObjectRegistry(Game.P_CAT);
	}

	public static void cleanupObjectRegistry() {
		SystemIniter.cleanupObjectRegistry(Game.P_CAT);
	}
	...
	public static void setupPreferences(URL url, final String args[],
		...
		try {
			...
			// use a simple configuration when log4j is not properly initialized.
	...
	public static void setupPreferences(final ParameterDatabase parameters) {
		...
		final CatpInfrastructure infrast = parameters.getInstanceForParameter(
				base.push(Game.P_INFRASTRUCTURE), null, CatpInfrastructure.class);
		if (infrast instanceof Parameterizable) {
			((Parameterizable) infrast).setup(parameters,
					base.push(Game.P_INFRASTRUCTURE));
		}
	...
	public static Collection<? extends MarketClient> createOptionalMarkets()
		...
		if ((dir == null) || !dir.exists() || !dir.isDirectory()) {
			...
			final String optionalBase = parameters.getString(
					optionalParam.push(Game.P_BASE), null);
			Game.logger.info("\n");
