...
public class GameClock implements Parameterizable, Runnable {
	...
	private static final String P_LOGGING = "logging";
	...
	public void setup(final ParameterDatabase parameters, final Parameter base) {
		...
		roundLen = parameters.getIntWithDefault(base.push(GameClock.P_ROUNDLEN),
				null, roundLen);
		roundClosingLen = parameters.getIntWithDefault(
				base.push(GameClock.P_ROUNDCLOSINGLEN), null, roundClosingLen);
		...
		dayInitLen = parameters.getIntWithDefault(base.push(GameClock.P_DAYINIT),
				null, dayInitLen);
		syncTimeout = parameters.getIntWithDefault(
				base.push(GameClock.P_SYNCTIMEOUT), null, syncTimeout);

		logging = parameters.getBoolean(base.push(P_LOGGING), null, logging);
