...
public class ResourceReport implements GameReport {
	...
	public void reportMemoryUse() {
		...
		if (logController.isLogging()) {
			...
			ResourceReport.logger
					.info(Utils.indent(" Used mem: " + usedMemory + "K"));
			ResourceReport.logger
					.info(Utils.indent(" Free mem: " + freeMemory + "K"));
			ResourceReport.logger.info(Utils
					.indent("Total mem: " + totalMemory + "K"));
