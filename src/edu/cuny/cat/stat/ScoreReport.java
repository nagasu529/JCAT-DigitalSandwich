...
public class ScoreReport extends DailyAssessmentReport implements
	...
	public void setup(final ParameterDatabase parameters, final Parameter base) {
		scoreDaysCondition = parameters.getInstanceForParameter(
				base.push(ScoreReport.P_CONDITION), null, ScoreDaysCondition.class);

		if (scoreDaysCondition instanceof Parameterizable) {
			((Parameterizable) scoreDaysCondition).setup(parameters,
					base.push(ScoreReport.P_CONDITION));
		}
	}
