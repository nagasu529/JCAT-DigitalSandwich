...
public class SpecialistInfo extends Specialist {
	...
	public SpecialistInfo(final String id) {
		this(id, Double.NaN, Double.NaN, Double.NaN, Double.NaN, Double.NaN);
	}

	public SpecialistInfo(final String id, final int scoreMemory) {
		this(id, Double.NaN, Double.NaN, Double.NaN, Double.NaN, Double.NaN);
	}

	public SpecialistInfo(final String id, final double registrationFee,
			final double informationFee, final double shoutFee,
			final double transactionFee, final double profitFee) {
	...
	public void setDailyProfit(final double dailyProfit) {
	...
	public void calculateDailyScore(final int totalNumOfTraders,
			final double dailySpecialistsProfit) {
	...
	public void addSupply(final int supply) {
		this.supply += supply;
	}

	public void addDemand(final int demand) {
		this.demand += demand;
	}
	...
	public void addNumOfTraders(final int numOfTraders) {
		this.numOfTraders += numOfTraders;
	}

	public void shoutPosted(final Shout shout) {
	...
	public void transactionPosted(final Transaction transaction) {
