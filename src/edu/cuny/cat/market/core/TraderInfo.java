...
public class TraderInfo extends Trader {
	...
	public TraderInfo(final String id, final String desc, final boolean isSeller) {
	...
	public void shoutPlaced(final double price) {
		if (isSeller) {
	...
	public void updateTrace(final int day) {
		lastDayTraced = day;
		numOfDaysTraced++;
		isTraced = true;
	}
	...
	public void increaseGoodsTraded(final int goodsTraded) {
	 ...
	 * 
	 */
	public void setMarginalStatus(final int marginalStatus) {
