...
public interface Auctioneer extends QuoteProvider, AuctionEventListener {
	 ...
	 * 
	 * @param type
	 *          a class or subclass of {@link Helper}
	 * @return the instance of the given helper type previously registered at this
	 *         auctioneer; null if no such a helper exists.
	 */
	public <H extends Helper> H getHelper(Class<H> type);

	/**
	 * register a {@link Helper}, which can be retrieved and used by
	 * {@link AuctioneerPolicy} to have additional capabilities that are shared
	 * with other policies.
	 * 
	 * @param type
	 * @param helper
