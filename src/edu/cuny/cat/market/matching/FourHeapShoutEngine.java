...
public class FourHeapShoutEngine extends ShoutEngine implements Serializable {
	...
	public Iterator<Shout> askIterator() {
		return new IteratorChain<Shout>(sIn.iterator(), sOut.iterator());
	}

	@Override
	public Iterator<Shout> ascendingAskIterator() {
		return new IteratorChain<Shout>(Utils.sortedIterator(sIn.iterator(),
				ShoutEngine.AscendingOrder), Utils.sortedIterator(sOut.iterator(),
				ShoutEngine.AscendingOrder));
	}

	@Override
	public Iterator<Shout> bidIterator() {
		return new IteratorChain<Shout>(bIn.iterator(), bOut.iterator());
	}

	@Override
	public Iterator<Shout> descendingBidIterator() {
		return new IteratorChain<Shout>(Utils.sortedIterator(bIn.iterator(),
				ShoutEngine.DescendingOrder), Utils.sortedIterator(bOut.iterator(),
				ShoutEngine.DescendingOrder));
	}

	@Override
	public Iterator<Shout> matchedAskIterator() {
		return Utils.sortedIterator(sIn.iterator(), ShoutEngine.AscendingOrder);
	}
	...
	public int getMatchedVolume() {
		return Shout.totalVolume(bIn.iterator());
	}
