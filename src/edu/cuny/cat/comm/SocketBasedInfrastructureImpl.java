...
import edu.cuny.net.LocalNetAddress;
...
public class SocketBasedInfrastructureImpl implements CatpInfrastructure,
	...
	public void setup(final ParameterDatabase parameters, final Parameter base) {
		...
		server = parameters.getStringWithDefault(
				base.push(SocketBasedInfrastructureImpl.P_SERVER),
				defBase.push(SocketBasedInfrastructureImpl.P_SERVER), server);

		port = parameters.getIntWithDefault(
				base.push(SocketBasedInfrastructureImpl.P_PORT),
				defBase.push(SocketBasedInfrastructureImpl.P_PORT), port);
	...
	protected void initialize() {
		...
		if (server == null) {
			try {
				server = LocalNetAddress.getAddress().getHostAddress();
