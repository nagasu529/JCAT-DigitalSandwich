 ...
 */
public class GuiConsole extends JFrame implements Console, RichEventListener,
	...
	public void setup(final ParameterDatabase parameters, final Parameter base) {
		...
		UiUtils.setup(startB, parameters,
				base.push(GuiConsole.P_BUTTON).push(GuiConsole.P_START));
		UiUtils.setup(pauseB, parameters,
				base.push(GuiConsole.P_BUTTON).push(GuiConsole.P_PAUSE));
		UiUtils.setup(resumeB, parameters,
				base.push(GuiConsole.P_BUTTON).push(GuiConsole.P_RESUME));
		UiUtils.setup(exitB, parameters,
				base.push(GuiConsole.P_BUTTON).push(GuiConsole.P_EXIT));
	...
	@Override
	public void eventOccurred(final RichEvent te) {
	...
	public void actionPerformed(final ActionEvent e) {
		if (e.getSource() == startB) {
			eventEngine.dispatchEvent(GameClock.class, new RichEvent(startB,
			...
			eventEngine.dispatchEvent(GameClock.class, new RichEvent(pauseB,
			...
			eventEngine.dispatchEvent(GameClock.class, new RichEvent(resumeB,
	...
	private void exit(final Object source) {
		...
		eventEngine.dispatchEvent(GameClock.class, new RichEvent(source,
