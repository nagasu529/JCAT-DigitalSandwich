...
public class FourHeapShoutEngineTest extends AbstractShoutEngineTest {

	TestShoutEngine shoutEngine;

	public FourHeapShoutEngineTest(final String name) {
		super(name);
	}

	@Override
	public FourHeapShoutEngine getShoutEngine() {
		return shoutEngine;
	}
	...
	public void testOrderedMatches() {
		this.checkOrderedMatches(true, false);
	}

	public static void main(final String[] args) {
		junit.textui.TestRunner.run(FourHeapShoutEngineTest.suite());
	}

	public static Test suite() {
		return new TestSuite(FourHeapShoutEngineTest.class);
	}
